...
class Args:
    ...
    opt_num_training_steps: arg.Int = 250_000
    # opt_num_training_steps: arg.Int = 350_000
...
def train(rank, args):
    ...
    for step in range(args.opt_num_training_steps+1):
        ...
        # print("#"*230)
        # print(f'{args.output_dir}/ckpt/{step}')
...
def main():
    ...
    args.output_dir = output_dir+ f"_{args.opt_num_training_steps}_steps_recheck_res" # just to track the training wiht the number of steps
    args.exp_id = exp_id
